...
// Enchantments (Boss Monsters Only)
#define MA_FIRE_ENCHANTED			0x00000001 // Fire enchanted
#define MA_LIGHTNING_ENCHANTED		0x00000002 // Lightning enchanted
#define MA_COLD_ENCHANTED			0x00000004 // Cold enchanted
#define MA_EXTRA_STRONG				0x00000008 // Extra strong
#define MA_EXTRA_FAST				0x00000010 // Extra fast
#define MA_MAGIC_RESISTANT			0x00000020 // Magic resistant
#define MA_STONE_SKIN				0x00000040 // Stone skin
#define MA_CURSED					0x00000080 // Cursed
#define MA_MANA_BURN				0x00000100 // Mana burn
#define MA_MULTI_SHOT				0x00000200 // Multishot
#define MA_SPECTRAL_HIT				0x00000400 // Spectral hit
#define MA_TELEPORT					0x00000800 // Teleport
#define MA_AURA_ENCHANTED			0x00001000 // Aura enchanted (see next)

// Auras (Boss Monsters Only)
#define MA_MIGHT					0x00002000 // Might aura
#define MA_HOLY_FIRE				0x00004000 // Holy fire aura
#define MA_HOLY_FREEZE				0x00008000 // Holy freeze aura
#define MA_HOLY_SHOCK				0x00010000 // Holy shock aura
#define MA_CONVICTION				0x00020000 // Conviction aura
#define MA_FANATICISM				0x00040000 // Fanaticism aura
#define MA_BLESSED_AIM				0x00080000 // Blessed aim aura

// Immunities
#define MA_IMMUNE_FIRE				0x00100000 // Immune to fire
#define MA_IMMUNE_LIGHTNING			0x00200000 // Immune to lightning
#define MA_IMMUNE_COLD				0x00400000 // Immune to cold
#define MA_IMMUNE_POISON			0x00800000 // Immune to poison
#define MA_IMMUNE_MAGIC				0x01000000 // Immune to magic
#define MA_IMMUNE_PHYSICAL			0x02000000 // Immune to physical
...
//////////////////////////////////////////////////////////////////////	
#define STORAGE_INVALID		-1	// Invalid
#define STORAGE_INVENTORY	0	// Inventory
#define STORAGE_EQUIP		1	// Equip
#define STORAGE_BELTSLOT	2	// Belt slot
#define STORAGE_CUBE		3	// cube
#define STORAGE_STASH		4	// stash

//////////////////////////////////////////////////////////////////////
// Character Equip Locations
//
// If used on merc, only head, body, right primary are available
//////////////////////////////////////////////////////////////////////
...
// Item Event Types
///////////////////////////////////////////////////////////////////////
#define	ITEM_EVENT_NEW_GROUND			0x00 //9c
#define	ITEM_EVENT_PICK_UP				0x01 //9c
#define	ITEM_EVENT_DROP					0x02 //9c
#define	ITEM_EVENT_OLD_GROUND			0x03 //9c
#define	ITEM_EVENT_TO_STORAGE			0x04 //9c
#define	ITEM_EVENT_FROM_STORAGE			0x05 //9d
#define	ITEM_EVENT_TO_EQUIP				0x06 //9d
#define	ITEM_EVENT_FROM_EQUIP			0x08 //9d
#define	ITEM_EVENT_SWITCH_EQUIP			0x09 //9d
#define	ITEM_EVENT_TO_STORE				0x0B //9c
#define	ITEM_EVENT_FROM_STORE			0x0C //9c
#define	ITEM_EVENT_SWITCH_STORAGE		0x0d //9c
#define	ITEM_EVENT_TO_BELTSLOT			0x0E //9c
#define	ITEM_EVENT_FROM_BELTSLOT		0x0F //9c
#define	ITEM_EVENT_SWITCH_BELTSLOT		0x10 //9c
#define ITEM_EVENT_TO_CURSOR			0x12 //9c
#define ITEM_EVENT_SHIFT_BELTSLOT		0x15 //9d
...
enum {
	...
	UM_HPPERCENT,		// Unit HP percentage changed, wParam: current HP percent, lParam: 0-normal unit, 1-hiring or summoning
	...
	UM_ITEMEVENT,		// Indicates events related to an item
	...
	PM_GOLDUPDATE,		// Gold update, wParam: 0-inventory, 1-stash, lParam: gold amount
};
