...
//---------------------------------------------------------------
// Section & Key Enumeration callbacks
//---------------------------------------------------------------
typedef BOOL (CALLBACK *fnEnumSectionsProc)(LPCTSTR lpSection, LPVOID lpParam);
typedef BOOL (CALLBACK *fnEnumKeysProc)(LPCTSTR lpKeyName, LPCTSTR lpValue, LPVOID lpParam);
...
public:		
...
#endif
	BOOL EnumSections(fnEnumSectionsProc lpfn, LPVOID lpParam) const;
...
#endif
	BOOL EnumKeys(LPCTSTR lpSection, fnEnumKeysProc lpfn, LPVOID lpParam) const;
	...
	// Helper Functions
	//------------------------------------------------------------
	static BOOL TrimString(LPTSTR lpBuffer);
